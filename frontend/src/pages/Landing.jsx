...
const Landing = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] w-full text-center px-4 relative">
      ...
      <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] bg-[#1B2838] rounded-full blur-[150px] opacity-20 pointer-events-none z-0" />
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-[#2a475e] rounded-full blur-[120px] opacity-15 pointer-events-none z-0" />

      <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-br from-white via-[#1DB954] to-[#1B2838] relative z-10 drop-shadow-2xl">
        Steamify.
      </h1>
      ...
      <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-2xl mb-12 leading-relaxed font-normal relative z-10 px-4">
        ...
        Bridge the gap between <span className="text-[#1DB954] font-semibold">Spotify</span> and <span className="text-[#1B2838] font-semibold">Steam</span>.
      </p>
      ...
      <div className="mt-8 sm:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 border-t border-white/20 pt-12 w-full max-w-4xl">
        ...
        <div className="text-center sm:text-left group">
            <div className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#1B2838] to-white mb-2 group-hover:from-[#2a475e] transition-all">50ms</div>
            <div className="text-xs sm:text-sm text-gray-400 uppercase tracking-wider font-bold">Latency</div>
        </div>
        <div className="text-center sm:text-left group">
            <div className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#1DB954] via-white to-[#1B2838] mb-2 transition-all">100%</div>
